...
while(1==1) {
    if(strtotime($startDate) <= strtotime($endDate)){
        ...
        $year = $date->format('Y');
        $fileURL = 'https://api.uspto.gov/api/v1/datasets/products/files/CPCMCPT/US_Grant_CPC_MCF_XML_'.$fileName;
...
exec('php -f /var/www/html/trash/patent_cpc_read_from_xml.php');
